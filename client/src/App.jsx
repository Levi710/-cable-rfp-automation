...
function App() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setData(mockData);
      setLoading(false);
    }, 1500); // reduced from 2000ms for snappier feel
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center h-[60vh]">
            <div className="w-16 h-16 border-4 border-tech-cyan border-t-transparent rounded-full animate-spin mb-4"></div>
            <p className="font-mono text-tech-cyan animate-pulse">INITIALIZING PIPELINE VISUALIZATION...</p>
          </div>
        ) : (
